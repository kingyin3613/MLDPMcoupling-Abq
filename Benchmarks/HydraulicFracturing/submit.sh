...
abaqus interactive analysis job=grasslDisk-fracture input=grasslDisk-fracture.inp USER=VUEL_MLDPM.for double=both ask_delete=OFF &
PID1=$!
echo $PID1

abaqus interactive analysis job=grasslDisk-fracture-edgeEle input=grasslDisk-fracture-edgeEle.inp USER=UEL_FLM.for ask_delete=OFF
PID2=$!
echo $PID2
...
# abaqus job=grasslDisk-fracture terminate
# abaqus job=grasslDisk-fracture-edgeEle terminate
