...
abaqus interactive analysis job=grasslDisk-nu01-b0 input=grasslDisk-nu01-b0.inp USER=VUEL_MLDPM.for double=both ask_delete=OFF &
PID1=$!
echo $PID1

abaqus interactive analysis job=grasslDisk-nu01-b0-edgeEle input=grasslDisk-nu01-b0-edgeEle.inp USER=UEL_FLM.for ask_delete=OFF
PID2=$!
echo $PID2
...
# abaqus job=grasslDisk-nu01-b0 terminate
# abaqus job=grasslDisk-nu01-b0-edgeEle terminate
